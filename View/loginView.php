...
class loginView
{
    ...
    {
        echo '
        <div id="alert" class="transition-all ease-in-out transform duration-150 absolute top-2 right-5 bg-red-50 border border-red-200 text-sm text-red-800 rounded-lg p-4" role="alert">
        <div class="flex">
            <div class="shrink-0">
